<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Regist.aspx.cs" Inherits="Regist" MasterPageFile="~/Ass2/HomeMaster.master" StylesheetTheme="Blue"%>
...
<asp:Content ID="homePage" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="thePanel" runat="server" SkinID="otherPanel">
        <asp:Label ID="title" runat="server" SkinID="pageTitle" Text="Registration"/><br />
         <asp:AccessDataSource ID="DS2" runat="server" DataFile="~/App_Data/userdb.accdb"
             DeleteCommand="DELETE FROM [userinfo] WHERE [ID] = ?" 
             InsertCommand="INSERT INTO [userinfo] ([ID], [gname], [fname], [emai], [dob], [gender], [blood], [java], [cs], [swift], [pyear], [addr], [state], [password]) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" 
             SelectCommand="SELECT * FROM [userinfo]" 
             UpdateCommand="UPDATE [userinfo] SET [gname] = ?, [fname] = ?, [emai] = ?, [dob] = ?, [gender] = ?, [blood] = ?, [java] = ?, [cs] = ?, [swift] = ?, [pyear] = ?, [addr] = ?, [state] = ?, [password] = ? WHERE [ID] = ?" >
             <DeleteParameters>
             ...
             <InsertParameters>
                 ...
                 <asp:Parameter Name="emai" Type="String" />
                 <asp:Parameter Name="dob" Type="String" />
                 <asp:Parameter Name="gender" Type="String" />
                 <asp:Parameter Name="blood" Type="String" />
                 <asp:Parameter Name="java" Type="String" />
        ...
        <asp:AccessDataSource ID="DS3" runat="server" DataFile="~/App_Data/userdb.accdb" DeleteCommand="DELETE FROM [user] WHERE [ID] = ?" InsertCommand="INSERT INTO [user] ([ID], [user_name], [password]) VALUES (?, ?, ?)" SelectCommand="SELECT * FROM [user]" UpdateCommand="UPDATE [user] SET [user_name] = ?, [password] = ? WHERE [ID] = ?" >
            <DeleteParameters>
                <asp:Parameter Name="ID" Type="Int32" />
            </DeleteParameters>
            <InsertParameters>
                ...
                <td>
                    <table align="center">
                        ...
                        <tr>
                            <td></td>
                            <td align="center">
                                <asp:Button ID="confirmButton" runat="server" Text="Confirm" OnClick="confirmButton_Click" SkinID="confirmButton"/><br />
                                <asp:HyperLink ID="linkAll" runat="server" Target="_blank" NavigateUrl="all.aspx" Text="Click here to see all record."/><br />
                                <asp:HyperLink ID="linkShow" runat="server" Target="_blank" NavigateUrl="show.aspx" Text="Click here to search a record."/>
                            </td>
                            <td></td>
                        </tr>
                    </table>
            ...
            <tr>
                <td>
                    <asp:Panel ID="userInfo" runat="server" CssClass="userInfo" Visible="false" HorizontalAlign="left">
                        ...
                        <asp:Label ID="user" runat="server" /><br />
                        <asp:HyperLink ID="google" runat="server" NavigateUrl="https://www.google.com.au" Text="Link to Google" />
                    </asp:Panel>
                </td>
            </tr>
        </table>
        <asp:HyperLink ID="linkSourceCode" runat="server" Target="_blank" NavigateUrl="Display.aspx?filename=Regist.aspx" ImageUrl="~/Pix/codebuttonAddRecords.jpg"/>
    </asp:Panel>
</asp:Content>
